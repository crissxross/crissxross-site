...
heroImage: '../assets/ChristineHeadShot.png'
---
import { Image } from 'astro:assets';
import ChristineHeadShot from '../assets/ChristineHeadShot.png';

<Image class="headshot" src={ChristineHeadShot} alt="Christine smiling" />
