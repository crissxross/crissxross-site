...
imageStrip: '/archive/fitting-the-pattern.png'
images:
  - ''
releaseDate: '2008'
...
<h2 class="step-2"> Video of a talk about <cite>Fitting the Pattern</cite></h2>

<VideoYouTube id={frontmatter.youtubeVideos[1].id} />

I gave this talk remotely as part of the Digital Textiles panel at NonfictioNOW, a conference on literary nonfiction, in Phoenix, Arizona, USA, in 2018.
